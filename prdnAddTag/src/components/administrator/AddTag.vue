            ...
            <div class="col-md-4 addCategoryList">
                ...
                <div class="row">
                    <div class="input-group input_fields_wrap subCatField col-md-12">
                        <input type="text" class="form-control" name="newSubServ" id="newSubServ" placeholder="Enter Tag-Connections" onclick="showServConnections() ">
...
<!-- <div class="modal" id="subServModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="subServModalDiv">
