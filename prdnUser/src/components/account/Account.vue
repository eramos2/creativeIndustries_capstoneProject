                                        ...
                                        <div class="account-details-form checkout-form-list">
                                            <form action="#">
                                                ...
                                                <div class="single-input-item">
                                                    ...
                                                    <input type="text" id="display-name" v-model="displayName"  placeholder="Display Name"/>
                                                </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="single-input-item">
                                                        <label for="current-pwd" class="required">Current
                                                            Password</label>
                                                        <input type="password" id="current-pwd" v-model="currentPassword" 
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="single-input-item">
                                                                <label for="new-pwd" class="required">New
                                                                    Password</label>
                                                                <input type="password" id="new-pwd" v-model="newPassword" 
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="single-input-item">
                                                                <label for="confirm-pwd" class="required">Confirm
                                                                    Password</label>
                                                                <input type="password" id="confirm-pwd" v-model="confirmPassword" 
