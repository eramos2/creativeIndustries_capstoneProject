<template>
  ...
  <div class id="request" role="tabpanel">
    <div class="myaccount-content">
      <form @submit.prevent="validateBeforeSubmit">
        ...
        <div class="container" id="requestBsnPage">
          <div class="row marginTop">
            <h2>
              <span class="glyphicon glyphicon-plus-sign marginTop"></span> Select a Pending Request
            </h2>
          </div>
          <div class="row">
            <div>
              ...
              >
                ...
                <option
                  v-for="(business, key) in requests"
                  :key="key"
                  :value="business.submissionId"
            ...
            <div class="col-lg-4 col-lg-4 col-sm-6 buttonMargin">
              <p>
                ...
                <b-modal
                  ...
                  title="ERROR"
                >
                  <p class="my-4">Submission Request Failed Some fields are empty or invalid</p>
                </b-modal>
              </p>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    reloadBusinesses() {
      ...
      this.$store.dispatch("getBusinessRequests");
    },
    ...
    onChange() {
      ...
      console.log(data);
      this.$store.dispatch("getBusinessSubmission", data).then(response => {
        console.log(response);
  ...
  computed: {
    requests() {
      return this.$store.state.administrators.businessRequests;
    },
    currentBusinessRequest() {
      return this.$store.state.administrators.currentBusinessRequest;
    },
    businesses() {
