...
<form @submit.prevent="validateBeforeSubmit"> 
    ...
    <div class="row">
        <div class="col-md-6 categoryList">
            <h5>Services</h5>
            <div>
                <select class="form-control" id="editServTypes" @change="onChange()" v-model="selected">
        ...
        <div class="row">
            <div class="col-md-6  categoryList">
                ...
                :key="key"
                 >
                <li class="input-group" name="material" :value="category.id"><strong>{{category.name}}</strong></li>
                <li 
                v-for="(subcategory, subcatKey) in category.subcategories"
                :key="subcatKey"
                class="catMargins">
      ...
      this.$store
        ...
        .then(response => {
          if (response.length > 0) {
            ...
            alert("Try Again edit service failed");
          }
        });
    },
    okModal() {
