    ...
    <div class="container listContainer">
      <div class="row">
        <div class="col-md-12 cpl-md-offset-4" id="topRow">
          <h2>
            <span class="glyphicon glyphicon-minus-sign addMarginTop"></span> Remove Services
          </h2>
          ...
          <div style="overflow-y: scroll; height:400px;">
            <ul class="list-group categoryFont" id="serviceList">
              <div v-for="(category, key) in services" :key="key">
                <li class="input-group" name="services" :value="category.id">
                ...
                >
                  <div class="radio">
                    <label>
                      <input type="radio" name="subService" v-model="ssid" :value="subcategory.id">
                      {{subcategory.name}}
                    </label>
                  </div>
                </li>
        ...
        <div class="row">
          <div class="col-lg-4 col-lg-4 col-sm-6 buttonMargin">
            <p>
              ...
              <button :disabled="errors.any()" type="submit">Remove Service</button>
              <b-modal
                v-model="modalShow"
                id="modal-center"
                @ok="okModal"
                ...
                title="Added"
              >
                <p class="my-4">The service was removed.</p>
              </b-modal>
              <b-modal
                ok-variant="danger"
                ok-only
              ...
              <b-modal
                ...
                title="ERROR"
              >
                <p class="my-4">Something went wrong, select a Service to remove.</p>
              </b-modal>
            </p>
          </div>
        </div>
