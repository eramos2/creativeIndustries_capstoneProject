                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 order-2 order-lg-1">
                            <subcategory-list-box></subcategory-list-box>
                          ...
                          <!--
                            ...
                            <div class="shop-products-wrapper">
                                <div class="tab-content">
                                    ...
                                    <subcategory-row-list :categories="resources.materials.categories"></subcategory-row-list>
...
<script>
import SubCategoryListBox from "./SubCategoryListBox.vue";
import SubCategoryGrid from "./SubCategoryGrid.vue";
import SubCategoryRowList from "./SubCategoryRowList.vue";

export default {
  components: {
    subcategoryListBox: SubCategoryListBox,
    subcategoryGrid: SubCategoryGrid,
    subcategoryRowList: SubCategoryRowList
  },
  computed: {
    resources() {
      console.log("Inside computed before getResources in SubCategoryList.vue");
