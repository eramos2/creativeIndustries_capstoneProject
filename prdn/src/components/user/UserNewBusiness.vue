                          ...
                          <div class="checkbox">
                            <label>
                              <input
                                type="checkbox"
                                name="tags"
                                :disabled="spids.length > 4 && spids.indexOf(0)==-1"
                                v-model="spids"
                                :value="0"
                              >Tubing
                            </label>
                          ...
                          <div class="checkbox">
                            <label>
                              <input
                                type="checkbox"
                                name="tags"
                                :disabled="spids.length > 4 && spids.indexOf(1)==-1"
                                v-model="spids"
                                :value="1"
                              >Ornaments
                            </label>
                          ...
                          <div class="checkbox">
                            <label>
                              <input
                                type="checkbox"
                                name="tags"
                                :disabled="spids.length > 4 && spids.indexOf(2)==-1"
                                v-model="spids"
                                :value="2"
                              >Decorative
                            </label>
                          ...
                          <div class="checkbox">
                            <label>
                              <input
                                type="checkbox"
                                name="tags"
                                :disabled="spids.length > 4 && spids.indexOf(3)==-1"
                                v-model="spids"
                                :value="3"
                              >Opaque
                            </label>
                          ...
                          <div class="checkbox">
                            <label>
                              <input
                                type="checkbox"
                                name="tags"
                                :disabled="spids.length > 4 && spids.indexOf(4)==-1"
                                v-model="spids"
                                :value="4"
                              >Breathable
                            </label>
                          ...
                          <div class="checkbox">
                            <label>
                              <input
                                type="checkbox"
                                name="tags"
                                :disabled="spids.length > 4 && spids.indexOf(5)==-1"
                                v-model="spids"
                                :value="5"
                              >Long Lasting
                            </label>
