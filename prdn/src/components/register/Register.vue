                            ...
                            <!-- <form class="form-register" action="#"> -->
                                ...
                                <fieldset>          
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('firstName') }">
                                        ...
                                        <div class="col-md-10">
                                            <!-- FIRST NAME -->
                                            <input name="firstName" v-validate="'required|alpha_dash|max:20'" type="text"  id = "firstName" v-model="firstName" placeholder="First Name" data-vv-validate-on="none" class="form-control" >
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('lastName') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name ="lastName" v-validate="'required|alpha_dash|max:20'" type="text" class="form-control" id="lastName" data-vv-validate-on="none" v-model="lastName" placeholder="Last Name">
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('email') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name="email" v-validate="'required|email'" :class="{'input': true, 'is-danger': errors.has('email') }" type="email" v-model="email" id="email" data-vv-validate-on="none0" placeholder="Email address" class="form-control"  >                    
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('occupation') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name ="occupation" v-validate="'required|max:15|alpha'" data-vv-validate-on="none"   type="text" class="form-control" id="occupation" v-model="occupation" placeholder="Occupation">
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('city') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name ="city" v-validate="'required|min:4|max:15|alpha'" data-vv-validate-on="none"  type="text" class="form-control" id="city" v-model="city" placeholder="City">
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('birthdate') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name ="birthdate" v-validate="'max:10|min:10|date_format:YYYY-MM-DD|date_between:1938-01-01,2000-01-01'" data-vv-validate-on="none0"  type="text" v-model="birthdate" class="form-control" id="birthdate" placeholder="Birthdate YYYY-MM-DD">
                                ...
                                <fieldset>
                                    ...
                                    <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('password') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name ="password"  v-validate="'required|min:8|max:15'" type="password"  data-vv-validate-on="none0" class="form-control" id="password" v-model="password" placeholder="Password" ref="password">
                                     ...
                                     <div :class="{'form-group d-md-flex align-items-md-center': true, 'has-error': errors.has('confirmedpassword') }">
                                        ...
                                        <div class="col-md-10">
                                            <input name ="confirmedpassword"  v-validate="'required|min:8|max:15|confirmed:password'"  type="password" data-vv-validate-on="none0" class="form-control" id="confirmedpassword" v-model="confirmedpassword" placeholder="Confirm Password">
