            ...
            <div class="col-md-4 addCategoryList">
                ...
                <div class="row">
                    <div class="input-group input_fields_wrap subCatField col-md-12">
                        <input type="text" class="form-control" name="newSubProc" id="newSubProc" placeholder="Enter Sub-Process"  onclick="showProcConnections() ">
...
<div class="modal" id="subProcModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="subProcModalDiv">
